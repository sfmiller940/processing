...
public void drawApoll( Circle circ1, Circle circ2, Circle circ3){
  ...
  colorMode(HSB, boxWidth );
  fill(0,boxWidth,boxWidth,boxWidth/8);
  Circle circ4 = solveApollonius( circ1, circ2, circ3, -1, -1,-1);
  ellipse( circ4.center[0], circ4.center[1] , circ4.diameter, circ4.diameter);
  fill(boxWidth / 8,boxWidth,boxWidth,boxWidth/8);
  circ4 = solveApollonius( circ1, circ2, circ3, 1, 1,1);
  ellipse( circ4.center[0], circ4.center[1] , circ4.diameter, circ4.diameter);
  fill(boxWidth / 4,boxWidth,boxWidth,boxWidth/8);
  circ4 = solveApollonius( circ1, circ2, circ3, -1, 1,1);
  ellipse( circ4.center[0], circ4.center[1] , circ4.diameter, circ4.diameter);
  fill(3 * boxWidth / 8,boxWidth,boxWidth,boxWidth/8);
  circ4 = solveApollonius( circ1, circ2, circ3, 1, -1, -1);
  ellipse( circ4.center[0], circ4.center[1] , circ4.diameter, circ4.diameter);
  fill(boxWidth / 2,boxWidth,boxWidth,boxWidth/8);
  circ4 = solveApollonius( circ1, circ2, circ3, 1, -1,1);
  ellipse( circ4.center[0], circ4.center[1] , circ4.diameter, circ4.diameter);
  fill(5 * boxWidth / 8,boxWidth,boxWidth,boxWidth/8);
  circ4 = solveApollonius( circ1, circ2, circ3, -1, 1, -1);
  ellipse( circ4.center[0], circ4.center[1] , circ4.diameter, circ4.diameter);
  fill(3 * boxWidth / 4,boxWidth,boxWidth,boxWidth/8);
  circ4 = solveApollonius( circ1, circ2, circ3, -1, -1, 1);
  ellipse( circ4.center[0], circ4.center[1] , circ4.diameter, circ4.diameter);
  fill(7 * boxWidth / 8,boxWidth,boxWidth,boxWidth/8);
  circ4 = solveApollonius( circ1, circ2, circ3, 1, 1,-1);
  ellipse( circ4.center[0], circ4.center[1] , circ4.diameter, circ4.diameter);
}
